...
export const ADMIN_PERMISSION_SEED: { key: string; description: string }[] = [
  ...
  { key: 'products.read', description: 'Read products' },
  {
    key: 'products.update',
    description:
      'Update products and their sub-resources (variants, images, categories)',
  },
  ...
  {
    key: 'orders.manage',
    description: 'Manage orders (implies all orders.* actions)',
  },
  {
    key: 'customers.manage',
    description:
      'Manage customers and groups (implies all customers.* actions)',
  },
  ...
  { key: 'cms.manage', description: 'Manage CMS pages, blocks, and sliders' },
  {
    ...
    description: 'View storefront email subscriptions (subscriber list)',
  },
  { key: 'reports.read', description: 'Access reports and exports' },
  {
    key: 'settings.manage',
    description: 'Platform settings and mail server configuration',
  },
  {
    key: 'mail.manage',
    description: 'Manage SMTP mailboxes and test connections',
  },
  {
    key: 'analytics.manage',
    description: 'Manage GA4 analytics and ecommerce tracking',
  },
];
