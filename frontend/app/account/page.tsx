...
export default function AccountPage() {
  ...
  return (
    <>
      <div className="mb-6">
        <h2 className="font-display text-2xl font-semibold tracking-tight text-foreground">Account Overview</h2>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div>
          <h3 className="font-display mb-4 text-lg font-semibold tracking-tight text-foreground">Account Information</h3>
        ...
        <div>
          <h3 className="font-display mb-4 text-lg font-semibold tracking-tight text-foreground">Quick Actions</h3>
          <div className="space-y-3">
      ...
      <div className={`mt-8 p-6 ${storefrontUi.card}`}>
        <h3 className="font-display text-lg font-semibold tracking-tight text-foreground">Subscription</h3>
        <p className="mt-1 text-sm text-muted-foreground">
          Subscribe with your email for updates and offers.
        </p>
        <div className="mt-4 max-w-xl">
          <SubscriptionSignupForm
            source="account"
            defaultEmail={user?.email ?? ''}
            inputId="account-subscription-email"
          />
        </div>
      </div>
    </>
