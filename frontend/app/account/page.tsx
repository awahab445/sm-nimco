...
export default function AccountPage() {
  ...
  return (
    <>
      <div className="mb-6">
        <h2 className="text-2xl font-semibold text-brand-text">Account Overview</h2>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div>
          <h3 className="mb-4 text-lg font-semibold text-brand-text">Account Information</h3>
          <div className="space-y-3">
            ...
            {user?.phone && (
              <div>
                ...
                <p className="text-brand-text">{user.phone}</p>
              </div>
            )}
            {user?.isGuest !== undefined && (
              <div>
                <p className="text-sm font-medium text-muted-foreground">Account Type</p>
                <p className="text-brand-text">{user.isGuest ? 'Guest' : 'Registered'}</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div>
          <h3 className="mb-4 text-lg font-semibold text-brand-text">Quick Actions</h3>
          <div className="space-y-3">
      ...
      <div className={`mt-8 p-6 ${storefrontUi.card}`}>
        <h3 className="text-lg font-semibold text-brand-text">Subscription</h3>
        <p className="mt-1 text-sm text-muted-foreground">
