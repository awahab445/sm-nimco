...
export function SmNimcoHero() {
  return (
    <section className="bg-gradient-to-r from-[var(--brand-purple-dark,#1e1035)] via-[var(--brand-purple-deep,#2e1a47)] to-[var(--brand-purple-dark,#1e1035)] px-4 py-16 text-white sm:px-8">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between md:flex-row">
        ...
        <div className="mt-8 flex justify-center md:mt-0">
          <div className="flex h-64 w-64 flex-col items-center justify-center rounded-3xl border-2 border-[var(--brand-gold-primary,#d4af37)]/30 bg-[var(--brand-purple-deep,#2e1a47)] p-4 text-center">
            <svg
            ...
            <h3 className="font-heading text-xl font-bold">Special Mix Nimco</h3>
